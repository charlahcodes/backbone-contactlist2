...
},{"./contacts_model":3,"backbone":10}],3:[function(require,module,exports){
'use strict';
...
var _viewsAdd_new = require('./views/add_new');

var _viewsAdd_new2 = _interopRequireDefault(_viewsAdd_new);

var _contacts_modelJs = require('./contacts_model.js');

var _contacts_modelJs2 = _interopRequireDefault(_contacts_modelJs);
...
var Router = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.$el.on('click', '.newButton', function (event) {
      var $button = (0, _jquery2['default'])(event.currentTarget);
      var route = $button.data('to');
      _this.navigate(route, { trigger: true });
    });
  ...
  addNewContact: function addNewContact() {
    ...
    this.$el.html(_viewsAdd_new2['default']);

    // Store form inputs and save to parse
    (0, _jquery2['default'])('#submit').click(function () {
      var newModel = new _contacts_modelJs2['default']({
...
},{"./contacts_collection":2,"./contacts_model.js":3,"./views/add_new":6,"./views/contact":7,"./views/contactlist":8,"backbone":10,"jquery":11}],6:[function(require,module,exports){
'use strict';
...
},{"../contacts_model":3,"jquery":11}],7:[function(require,module,exports){
"use strict";
...
},{"jquery":11,"underscore":12}],10:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
